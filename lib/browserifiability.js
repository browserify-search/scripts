...
module.exports = function(module, testSummary, callback){
  ...
  var criteria = [
    ...
    //new Feature('hasPluginInDescription'),
    //new Feature('hasPluginInReadme'),
...
function browserifiability(module, testSummary, criteria){
  ...
  for (var i = 0; i < criteria.length; i++){
    ret = Pgood / (Pgood + Pbad)
    //console.log('p', ret, Pgood, Pbad)
